...
impl InsertMerkleProofCircuit {
    pub fn new(proof: &InsertProof) -> Result<InsertMerkleProofCircuit, DeimosError> {
        let non_membership_root = hex_to_scalar(&proof.non_membership_proof.merkle_proof.root_hash)
        ...
        // TODO: i think we have to build different merkle proofs here
        Ok(InsertMerkleProofCircuit {
            non_membership_root,
            non_membership_path: proof.non_membership_proof.merkle_proof.path.clone(),
